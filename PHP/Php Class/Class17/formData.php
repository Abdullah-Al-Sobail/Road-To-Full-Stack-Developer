 ...
 include './env.php';
    ...
    if(isset($_POST['button'])){
        ...
        if(empty($_POST['gender'])){
            ...
            $query = "INSERT INTO post(name,email,website,comment,gender) VALUES('$name','$email','$website','$comment','$gender')";
    ...
    //         Website :<a href="<?php echo $website; ?>"><?php echo $website;?></a><br>
    // <?php
